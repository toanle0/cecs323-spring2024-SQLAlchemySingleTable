...
# given that there might be multiple unique attributes for a department.
department_select = Menu('department select', 'Please select how you want to select a department:', [
    ...
    # Add more options here if there are other unique attributes you'd like to use for selecting a department
])
